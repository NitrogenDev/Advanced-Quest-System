	...
	UPackage* Z_Construct_UPackage__Script_QuestSystem()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_QuestSystem_AddedRemovedQuest__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_QuestSystem_QuestNotification__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_QuestSystem_SelectQuest__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_QuestSystem_StepUpdate__DelegateSignature,
			};
